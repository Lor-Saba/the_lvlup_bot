module.exports = [
    ...
    { target: 'exp', type: 'perm', name: 'CARROT',       weight: 100, power: 0.010, powermode: '+', craft: [] },
    ...
    { target: 'exp', type: 'perm', name: 'BIRD',         weight: 60,  power: 0.015, powermode: '+', craft: [] },
    { target: 'exp', type: 'perm', name: 'PAPER',        weight: 60,  power: 0.015, powermode: '+', craft: ['BOOK'] },
    { target: 'exp', type: 'perm', name: 'MAGNET',       weight: 60,  power: 0.015, powermode: '+', craft: [] },
    { target: 'exp', type: 'perm', name: 'IRONINGOT',    weight: 60,  power: 0.015, powermode: '+', craft: ['GOLDINGOT'] },
    { target: 'exp', type: 'perm', name: 'SAUCE',        weight: 60,  power: 0.016, powermode: '+', craft: ['BBQ'] },
    ...
    { target: 'exp', type: 'perm', name: 'PELUCHE',      weight: 35,  power: 0.020, powermode: '+', craft: ['COSPLAY'] },
    { target: 'exp', type: 'perm', name: 'FORMULA',      weight: 35,  power: 0.022, powermode: '+', craft: ['GOLDINGOT'] },
    { target: 'exp', type: 'perm', name: '4LEAFCLOVER',  weight: 35,  power: 0.025, powermode: '+', craft: ['LUCKYAMULET'] },
    { target: 'exp', type: 'perm', name: 'CAKE',         weight: 20,  power: 0.035, powermode: '+', craft: [] },
    ...
    { target: 'exp', type: 'perm', name: 'COSPLAY',      weight: 0,   power: 0.100, powermode: '+', recipe: [{ name: 'PELUCHE', quantity: 4 }] },
    { target: 'exp', type: 'perm', name: 'LUCKYAMULET',  weight: 0,   power: 0.140, powermode: '+', recipe: [{ name: '4LEAFCLOVER', quantity: 4 }] },
    { target: 'exp', type: 'perm', name: 'GOLDINGOT',    weight: 0,   power: 0.045, powermode: '+', recipe: [{ name: 'IRONINGOT', quantity: 1 },{ name: 'FORMULA', quantity: 1 }], craft: ['CROWN'] },
    { target: 'exp', type: 'perm', name: 'CROWN',        weight: 0,   power: 0.200, powermode: '+', recipe: [{ name: 'GOLDINGOT', quantity: 3 }]}
